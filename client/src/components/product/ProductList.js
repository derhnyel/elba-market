                    ...
                    <div className="row justify-content-center">
                        <div className="col-12 col-md-10 col-lg-8 col-xl-6">
                            ...
                            <div className="nav justify-content-center mb-10">
                                <a className="nav-link active" href="#topSellersTab" data-toggle="tab">Fruits</a>
                                <a className="nav-link" href="#topSellersTab" data-toggle="tab">Vegetables</a>
                                <a className="nav-link" href="#topSellersTab" data-toggle="tab">LiveStock</a>
                            </div>
                                ...
                                <div className="col-6 col-md-4 col-lg-3">
                                    ...
                                    <div className="card mb-7">
                                        ...
                                        <div className="card-img">
                                            ...
                                            {/* <!-- Image --> */}
                                            <a className="card-img-hover" href="/product/product-id">
                                        ...
                                        <div className="card-body px-0">
                                            ...
                                            <div className="font-weight-bold">
                                                <a className="text-body" href="/product/product-id">
